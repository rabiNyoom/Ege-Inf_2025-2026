...
def b():
    ...
    q1 = int(abs(sum(x for x, y in centroids) / len(centroids)) * 10000)
    q2 = int(abs(sum(y for x, y in centroids) / len(centroids)) * 10000)
